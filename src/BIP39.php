<?php
    ...
    // Generate Package base on https://github.com/blocker-solutions/bip39/blob/master/src/Bip39.php
    use blackpanda\bip39\Buffer\BitBuffer;
    use blackpanda\bip39\Util\Entropy;
    use blackpanda\bip39\Util\WordsList;
    ...
    class BIP39
    {
        ...
        public function __construct(string $locale = 'en')
        {
            ...
            $this->locale = $locale;
            // assign word list.
            $this->wordList = new WordsList($locale);
        }
